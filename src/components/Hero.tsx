  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-20 left-1/4 w-72 h-72 bg-accent/10 rounded-full blur-3xl"
      />
      <motion.div
        animate={{
          x: [0, -20, 0],
        ...
        className="absolute bottom-10 right-1/4 w-96 h-96 bg-accent-secondary/10 rounded-full blur-3xl"
      />
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-24 md:py-36">
        ...
        >
          ...
          <motion.p
            ...
            className="max-w-2xl mx-auto text-lg md:text-xl text-muted mb-10"
          >
            Deep dives into artificial intelligence, machine learning, cloud computing, 
            and the technologies reshaping our digital world.
          </motion.p>
